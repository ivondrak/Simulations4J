...
public class Queue {
	...
	public void show() {
		...
		System.out.println(new Integer(numOfEntries).toString()+" items entered!");
		System.out.println(new Integer(numOfDepartures).toString()+" items left!");
		System.out.println("Its current length is: "+new Integer(length).toString());
		System.out.println("Mean length is: "+new Float(mean).toString());
		System.out.println("Max length is: "+new Integer(max).toString());
		System.out.println("Mean delay is: "+new Float(delay).toString());
	}
